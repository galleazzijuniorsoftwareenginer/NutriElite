...
// Recorrido por las 5 pestañas del asistente "Nuevo plan" — todas están
...
export const planWizardTourSteps: TourStep[] = [
  {
    ...
    title: '1. Datos y Cálculo',
    body: 'Antropometría del paciente, fórmula metabólica (Mifflin, Harris-Benedict, Schofield…), objetivo y ETA calculan el GEB/GET en vivo. Al crear el plan, ajusta el GET final (±500 kcal) y el % de macros en la misma pantalla — los gramos se recalculan al momento.',
  },
  {
    target: '[data-tour="wizard-step-auditoria"]',
    title: '2. Auditoría SMAE',
